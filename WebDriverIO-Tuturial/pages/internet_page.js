class Internet{
  ...
  get droppsbleParagraph() {return $('#droppable > p')}
  ...
  /**
   * click the specified alert button
  ...
  /**
   * click the link "click here" link
   */
  clickHereLink() {
  ...
  /**
   * Send keybord key to target
   * @param {String} text the keyboar text to enter
   */
  ...
  /**
   * Returns the text of the figure destails
   * @param {Number} index the index of the element
   */
